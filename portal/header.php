				...
				<div class="wdth">
					<div class="logo left">
						<a href="index.php" style="text-decoration: none !important;">
						    ...
						    <h1 style="background: -webkit-linear-gradient(#9A42F3, #9A42F3); -webkit-background-clip: text; -webkit-text-fill-color: transparent;position: relative; margin:-37px 0 0 45px;font-size: 32px; ">Hugme Portal</h1>
						</a>
					</div>

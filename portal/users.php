		...
		if($json_data['code'] !== "200"){
			...
			foreach( $json_data['msg'] as $str => $val ) {
				...
				<tr style=" text-align: center;">
					...
					<td>
					    <span class="fas fa-info-circle" style="font-size: 20px; color: #9A42F3;" onclick="ViewProfile('<?php echo $val['fb_id']; ?>','<?php echo $val['like_count']; ?>','<?php echo $val['dislike_count']; ?>');"></span>
					</td>
